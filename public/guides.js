...
(function exposeGuideCatalog() {
  ...
  const guides = [
    ...
    },
    {
      ...
      title: "Personagem, atributos e ranks",
      description: "Entenda seus dez atributos, o crescimento de Vida, os ranks ninja e as regras de morte permanente.",
      category: "inicio",
      icon: "guide-attributes",
      order: 4,
      type: "guide",
      readingTime: 12,
      keywords: ["atributos", "Vida", "HP", "nível", "rank", "Academia", "Genin", "Chunin", "Jonin", "ANBU", "Kage", "morte permanente", "reset"],
      sections: [
        {
      ...
      related: ["traits", "arvores-e-jutsus", "combate-tatico"],
    },
    {
      slug: "traits",
