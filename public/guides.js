      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: "cards", items: [
              { title: "Cristal", text: "Terra + Água", image: "/assets/icons/footer/cristal.png", imageAlt: "Ícone de Cristal" },
              { title: "Vapor", text: "Fogo + Água", image: "/assets/icons/footer/vapor.png", imageAlt: "Ícone de Vapor" },
              { title: "Calor", text: "Fogo + Vento", image: "/assets/icons/footer/calor.png", imageAlt: "Ícone de Calor" },
              { title: "Lava", text: "Fogo + Terra", image: "/assets/icons/footer/lava.png", imageAlt: "Ícone de Lava" },
              { title: "Explosão", text: "Terra + Raio", image: "/assets/icons/footer/explosao.png", imageAlt: "Ícone de Explosão" },
              { title: "Poeira", text: "Fogo + Terra + Vento", image: "/assets/icons/footer/poeira.png", imageAlt: "Ícone de Poeira" },
              { title: "Gelo", text: "Água + Vento", image: "/assets/icons/footer/gelo.png", imageAlt: "Ícone de Gelo" },
            ] },
