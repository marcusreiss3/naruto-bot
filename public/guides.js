  ...
  const guides = [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            { type: "paragraph", text: "Os três Giros gratuitos fazem parte da primeira ficha. Giros adicionais de Clã e de Traço permitem uma nova rolagem para ajustar sua origem ou sua build depois desse momento. Um Giro de Clã sorteia uma combinação válida de Vila + Clã." },
            { type: "cards", items: [
              { title: "Ingots", text: "Giros adicionais usam Ingots. Use `/loja-premium` para comprar e usar Giros de Clã ou de Traço." },
              { title: "Boost do servidor", text: "O Boost do servidor também pode conceder Giros de Clã e de Traço." },
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: "cards", items: [
              { title: "Cristal", text: "Terra + Água", image: "/assets/icons/footer/cristal.png", imageAlt: "Ícone de Cristal", imageOpticalCenter: true },
              { title: "Vapor", text: "Fogo + Água", image: "/assets/icons/footer/vapor.png", imageAlt: "Ícone de Vapor", imageOpticalCenter: true },
              { title: "Calor", text: "Fogo + Vento", image: "/assets/icons/footer/calor.png", imageAlt: "Ícone de Calor", imageOpticalCenter: true },
              { title: "Lava", text: "Fogo + Terra", image: "/assets/icons/footer/lava.png", imageAlt: "Ícone de Lava", imageOpticalCenter: true },
              { title: "Explosão", text: "Terra + Raio", image: "/assets/icons/footer/explosao.png", imageAlt: "Ícone de Explosão", imageOpticalCenter: true },
              { title: "Poeira", text: "Fogo + Terra + Vento", image: "/assets/icons/footer/poeira.png", imageAlt: "Ícone de Poeira", imageOpticalCenter: true },
              { title: "Gelo", text: "Água + Vento", image: "/assets/icons/footer/gelo.png", imageAlt: "Ícone de Gelo", imageOpticalCenter: true },
            ] },
    ...
    {
      slug: "estilos-de-luta",
      title: "Estilos de luta",
      description: "Encontre os mestres, reúna os recursos pedidos e vença o desafio para liberar um estilo de luta.",
      category: "progressao",
      icon: "guide-fighting-styles",
      order: 8,
      type: "guide",
      readingTime: 5,
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: "links", items: [
              ...
              { slug: "itens-e-equipamentos", section: "coleta-e-producao", title: "Reunir materiais", text: "Veja coleta, receitas e inventário antes de aceitar o desafio." },
            ] },
          ],
        },
        {
          id: "depois-do-desafio",
          title: "Depois do desafio",
          blocks: [
            { type: "paragraph", text: "Ao vencer o mestre, o estilo fica disponível na Árvore de Habilidade correspondente. Abra a árvore para conferir requisitos, passivas e técnicas que a nova rota libera." },
            { type: "links", items: [{ slug: "arvores-e-jutsus", section: "como-comprar", title: "Abrir Árvores, afinidades e jutsus", text: "Entenda como comprar habilidades e planejar a progressão." }] },
          ],
        },
      ],
      related: ["arvores-e-jutsus", "mundo-e-viagem", "itens-e-equipamentos"],
    },
    {
      slug: "combate-tatico",
      ...
      sections: [
        {
          ...
          blocks: [
            ...
            { type: "callout", tone: "info", title: "O que é mantido", text: "Clã, Traço, Ingots e Giros não são perdidos. Os Ingots e Giros ficam vinculados à conta do Discord e continuam disponíveis para a nova ficha do jogador." },
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: "list", items: ["Use `/equipar item` para preparar uma arma permitida.", "Use `/atacar alvo` quando a arma equipada possuir um golpe compatível; sem arma, o comando usa Soco.", "A Katana equipada usa **Cortar com Katana**, um ataque de Kenjutsu de curta distância que escala com Kenjutsu.", "Use `/desequipar` para guardar a arma sem consumi-la.", "Sempre confira a habilidade exigida antes de comprar ou planejar um equipamento especializado."] },
          ],
        },
        {
