...
- Configurar `/loja` nos centros comerciais confirmados de Konoha, Suna e Kiri. Kumo/Iwa devem informar “mercado não configurado” até a staff cadastrar IDs reais.
...
- Vender ingrediente pessoal à loja paga o jogador segundo `shopBuyBase`, reduz o cofre e move o item para estoque da loja. Validar cofre livre, orçamento diário, capacidade e inventário antes de confirmar.
