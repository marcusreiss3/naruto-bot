...
export const DAILY_QUESTS: readonly DailyQuestDef[] = [
  ...
  { id: "gather_wood", kind: "GATHER", description: "Colete 10 Madeiras com /acao coletar.", target: 10, action: "COLETAR", itemId: "madeira" },
  { id: "gather_meat", kind: "GATHER", description: "Colete 10 Carnes Cruas com /acao cacar.", target: 10, action: "CACAR", itemId: "carne_crua" },
  { id: "gather_fish", kind: "GATHER", description: "Colete 10 Peixes Crus com /acao pescar.", target: 10, action: "PESCAR", itemId: "peixe_cru" },
  { id: "gather_water", kind: "GATHER", description: "Colete 12 Águas Limpas com /acao coletar-agua.", target: 12, action: "COLETAR_AGUA", itemId: "agua_limpa" },
  { id: "gather_iron", kind: "GATHER", description: "Colete 8 Minérios de Ferro com /acao minerar.", target: 8, action: "MINERAR", itemId: "minerio_ferro" },
