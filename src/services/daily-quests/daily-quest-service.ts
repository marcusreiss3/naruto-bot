...
export const WEEKLY_QUESTS: readonly WeeklyQuestDef[] = [
  ...
  { id: "weekly_gather_wood", kind: "GATHER", description: "Colete 100 Madeiras com /acao coletar.", target: 100, action: "COLETAR", itemId: "madeira" },
  { id: "weekly_gather_meat", kind: "GATHER", description: "Colete 100 Carnes Cruas com /acao cacar.", target: 100, action: "CACAR", itemId: "carne_crua" },
  { id: "weekly_gather_fish", kind: "GATHER", description: "Colete 100 Peixes Crus com /acao pescar.", target: 100, action: "PESCAR", itemId: "peixe_cru" },
  { id: "weekly_gather_water", kind: "GATHER", description: "Colete 100 Águas Limpas com /acao coletar-agua.", target: 100, action: "COLETAR_AGUA", itemId: "agua_limpa" },
  { id: "weekly_gather_iron", kind: "GATHER", description: "Colete 100 Minérios de Ferro com /acao minerar.", target: 100, action: "MINERAR", itemId: "minerio_ferro" },
