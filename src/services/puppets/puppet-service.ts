...
export function puppetCapabilities(owned: Iterable<string>): PuppetCapabilities {
  ...
  return {
    ...
    shellDamageBonus: nodes.has("kugutsu_carapaca_ofensiva_iv") ? 0.35 : nodes.has("kugutsu_carapaca_ofensiva_iii") ? 0.25 : nodes.has("kugutsu_carapaca_ofensiva_ii") ? 0.18 : nodes.has("kugutsu_carapaca_ofensiva") ? 0.10 : 0,
