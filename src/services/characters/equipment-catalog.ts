...
export const GUIDE_CATALOG_SCHEMA_VERSION = 60;
  ...
  const commandGroups = [
    ...
    },
    {
      ...
      commands: [
        ...
        { command: "/criar receita quantidade", description: "Produz uma receita pessoal na quantidade informada, se houver materiais." },
