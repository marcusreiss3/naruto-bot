...
export async function renderProfileCard(data: ProfileCardData): Promise<Buffer> {
  ...
  const scrollRolls = `<g><rect x="10" y="36" width="34" height="603" rx="17" fill="#71352a"/><rect x="15" y="43" width="24" height="589" rx="12" fill="#c99a4c"/><path d="M18 60v554M36 60v554" stroke="#f1d78d" stroke-opacity=".75" stroke-width="2"/><ellipse cx="27" cy="43" rx="17" ry="10" fill="#e1bd68" stroke="#71352a" stroke-width="3"/><ellipse cx="27" cy="632" rx="17" ry="10" fill="#b77a35" stroke="#71352a" stroke-width="3"/><rect x="1156" y="36" width="34" height="603" rx="17" fill="#71352a"/><rect x="1161" y="43" width="24" height="589" rx="12" fill="#c99a4c"/><path d="M1164 60v554M1182 60v554" stroke="#f1d78d" stroke-opacity=".75" stroke-width="2"/><ellipse cx="1173" cy="43" rx="17" ry="10" fill="#e1bd68" stroke="#71352a" stroke-width="3"/><ellipse cx="1173" cy="632" rx="17" ry="10" fill="#b77a35" stroke="#71352a" stroke-width="3"/></g>`;
  ...
  void svg;
  return sharp(Buffer.from(themedParchment)).png().toBuffer();
}
