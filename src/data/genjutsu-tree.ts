...
export const GENJUTSU_TREE: SkillNodeDef[] = [
  ...
  passive("gen_ecos_cativeiro", "Ecos do Cativeiro", "⛓️", "Aprisionamento", -1.25, 2, ["gen_raizes_obscuras"], 8, 7, "Passiva: a Imobilização aplicada pelos seus Genjutsus dura 1 rodada a mais."),
  jutsu("gen_arvore_assassina", "Aprisionamento da Árvore Assassina", "B", "🌳", "Aprisionamento", -1.25, 3, ["gen_ecos_cativeiro"], 14, 12, "O usuário desaparece como névoa e, ao reaparecer, uma árvore ilusória cresce ao redor do alvo e fecha seus galhos sobre ele."),
  jutsu("gen_interrogatorio", "Genjutsu: Interrogatório", "B", "🕯️", "Aprisionamento", -1.25, 4, ["gen_arvore_assassina"], 20, 17, "O mundo ao redor do alvo se apaga, restando apenas uma sala vazia onde vozes invisíveis pressionam sua mente."),

  // ------------------------------------------------------------ Ilusão/Fuga
  jutsu("gen_contra_genjutsu", "Contra-Genjutsu", "C", "🔓", "Ilusão/Fuga", 0, 1, ["gen_raiz"], 3, 3, "O usuário reorganiza o próprio fluxo de chakra, desfazendo as distorções que sustentam uma ilusão."),
