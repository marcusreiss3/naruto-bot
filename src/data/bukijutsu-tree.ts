...
export const BUKIJUTSU_TREE: SkillNodeDef[] = [
  ...
  },
  {
    ...
    requires: ["buki_manipulacao_fios"], reqLevel: 1, reqPool: 1, grantsAbilityId: "buki_moinho",
  ...
  },
  {
    ...
    requires: ["buki_arsenal_selado"], reqLevel: 4, reqPool: 4,
  ...
  },
  {
    ...
    requires: ["buki_lamina_chakra"], reqLevel: 4, reqPool: 4,
  ...
  },
  {
    ...
    requires: ["buki_afinidade_lamina"], reqLevel: 6, reqPool: 6, grantsAbilityId: "buki_voo_andorinha",
  ...
  },
  {
    ...
    pool: "bukijutsu", cost: 2, branch: "Arremessos", col: 0, row: 5,
  ...
  },
  {
    ...
    pool: "bukijutsu", cost: 6, branch: "Arremessos", col: -0.75, row: 5,
