...
export const KAGE_BUNSHIN_ABILITIES: Ability[] = [
  {
    id: "invocacao_rei_macaco_enma",
    name: "Invocação: Rei Macaco Enma",
    category: "NINJUTSU",
    tier: 4,
    resource: "chakra",
    cost: 32,
    ...
    range: 0,
    shape: "SELF",
    summon: { templateId: "summon_rei_macaco_enma", maxAlive: 1, actsNextRound: true },
    requirements: { manualOnly: true },
    tags: ["invocacao", "enma", "taijutsu"],
    description: "Invoca o Rei Macaco Enma. Ele entra em campo e luta por conta própria a partir da próxima rodada.",
  },
  {
    id: "enma_golpe_bastao_adamantino",
    name: "Golpe do Bastão Adamantino",
    category: "TAIJUTSU",
    tier: 4,
    resource: "energia",
    cost: 0,
    ...
    shape: "MELEE",
    requirements: { manualOnly: true },
    tags: ["enma", "taijutsu", "bastao"],
    description: "Enma avança e golpeia o alvo com a força do Bastão Adamantino.",
  },
  {
    id: "enma_prisao_adamantina",
    name: "Prisão Adamantina",
    category: "TAIJUTSU",
    tier: 4,
    resource: "energia",
    cost: 0,
    ...
    requirements: { manualOnly: true },
    tags: ["enma", "taijutsu", "controle"],
    description: "Enma se divide em bastões adamantinos, prende o alvo e o deixa Imobilizado.",
  },
  {
    id: "kage_bunshin",
