...
const attack = (id: string, name: string, baseDamage: number, range: number, description: string, effects: Ability["effects"] = []): Ability => ({
  id, name, category: "KUGUTSU", tier: 1, resource: "chakra", cost: 8, actionType: "COMUM",
...
export const KUGUTSU_ABILITIES: Ability[] = [
  attack("kugutsu_tiro_mecanismo_destrutivo", "Tiro de Mecanismo Destrutivo", 24, 3, "A marionete dispara kunais escondidas pela boca.", [{ effectId: "BLEED", stacks: 1, duration: 2 }]),
  { id: "kugutsu_capturar", name: "Capturar", category: "KUGUTSU", tier: 1, resource: "chakra", cost: 8, actionType: "COMUM", baseDamage: 0, scalingAttribute: "kugutsu", range: 1, shape: "SINGLE_TARGET", effects: [{ effectId: "ROOT", duration: 1 }], tags: ["kugutsu", "puppet-attack"], description: "Compartimentos da marionete se fecham sobre o alvo e o imobilizam." },
  attack("kugutsu_lamina_agulha", "Lâmina Agulha", 18, 2, "Uma agulha venenosa salta da cabeça da marionete.", [{ effectId: "POISON", stacks: 1, duration: 3 }]),
  { id: "kugutsu_ataque_super_arma", name: "Ataque da Super Arma", category: "KUGUTSU", tier: 1, resource: "chakra", cost: 12, actionType: "COMUM", baseDamage: 20, scalingAttribute: "kugutsu", range: 3, shape: "RADIUS", effects: [{ effectId: "POISON", stacks: 1, duration: 3 }], tags: ["kugutsu", "puppet-attack"], description: "A marionete libera uma bomba de veneno em área curta." },
  attack("kugutsu_multiplos_bracos", "Múltiplos Braços", 22, 1, "Braços mecânicos envolvem o alvo e interrompem seus movimentos.", [{ effectId: "STUN", duration: 1, chance: 0.65 }]),
  ...
  attack("kugutsu_lanca_chamas", "Lança-Chamas", 28, 2, "Um bocal de fogo cospe chamas sobre o alvo.", [{ effectId: "BURN", stacks: 1, duration: 3 }]),
  attack("kugutsu_cauda_escorpiao", "Cauda de Escorpião", 25, 2, "A cauda perfura o alvo com veneno e lâmina.", [{ effectId: "POISON", stacks: 1, duration: 3 }, { effectId: "BLEED", stacks: 1, duration: 2 }]),
  ...
  attack("kugutsu_dama_ferro", "Dama de Ferro", 48, 1, "Duas marionetes coordenam a execução mecânica de um alvo capturado.", [{ effectId: "BLEED", stacks: 3, duration: 3 }]),
  { ...attack("kugutsu_atacando_ambos_lados", "Atacando de Ambos os Lados", 38, 2, "Duas marionetes atacam em pinça; não há espaço para esquiva."), undodgeable: true },
];
