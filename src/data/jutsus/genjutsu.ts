...
export const GENJUTSU_ABILITIES: Ability[] = [
  ...
  {
    id: "gen_alicerce_relampago_ilusorio",
    name: "Alicerce de Relâmpago Ilusório",
    category: "GENJUTSU",
    tier: 2,
    resource: "chakra",
    cost: 22,
    ...
    range: 3,
    shape: "RADIUS",
    effects: [{ effectId: "CONFUSION", duration: 2, chance: 0.75 }, { effectId: "DEFENSE_DOWN", duration: 1, chance: 0.75 }],
    requirements: { manualOnly: true, attributes: { genjutsu: 13 }, level: 14 },
    tags: ["genjutsu", "area", "controle", "relampago"],
    description: "Uma luz intensa irrompe do usuário e pode deixar os inimigos Confusos e com a Defesa Reduzida.",
  },
  {
