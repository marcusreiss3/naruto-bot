...
const mist: SkillNodeDef = {
  ...
  element: "AGUA", grantsAbilityId: "tai_ocultacao_nevoa", requiresVillage: "KIRI",
...
export const ASSASSINATO_NINJA_TREE: SkillNodeDef[] = [
  ...
  passive("tai_nevoa_ofuscante", "Névoa Ofuscante", "taijutsu", -1, 3, ["tai_nevoa_ponto_cego"], 28, 28, "Passiva: enquanto houver uma Cortina de Neblina no campo, seus ataques de Taijutsu ou Kenjutsu causam 10% mais dano."),
  passive("tai_nevoa_danca", "Dança da Névoa", "taijutsu", -1, 4, ["tai_nevoa_ofuscante"], 34, 34, "Passiva: ao acertar com Taijutsu ou Kenjutsu enquanto houver névoa no campo, você recebe Aceleração até o fim da próxima rodada."),
  ...
  passive("tai_nevoa_saque", "Saque Relâmpago", "kenjutsu", 1, 3, ["tai_nevoa_ponto_cego"], 30, 30, "Passiva: você recebe +1 de prioridade no início do combate e seu primeiro ataque de Kenjutsu causa 14% mais dano."),
  passive("tai_nevoa_corte", "Corte Decisivo", "kenjutsu", 1, 4, ["tai_nevoa_saque"], 40, 40, "Passiva: após passar uma rodada sem atacar, seu próximo ataque de Kenjutsu causa 18% mais dano e corta 18% da redução de Bloqueio/Aparo."),
];
